...
const products = [
    {
        ...
        description: "I'm just a placeholder description — here to hold the fort until the real words show up. I’m here for moral support and to keep the layout from collapsing in existential crisis.",
        price: 20.0,
    ...
    },
    {
        ...
        snapshot: "Inspiring and encouraging poster for finding a cure or recovering.",
        description: "I'm just a placeholder description — here to hold the fort until the real words show up. I’m here for moral support and to keep the layout from collapsing in existential crisis.",
        price: 20.0,
